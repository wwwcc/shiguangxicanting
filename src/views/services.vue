        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <h1>Deliccio</h1> <span>Healthy And Tasty Food</span></a>
            </div>
    ...
    <div class="content">
        <div class="container">
            <div class="col-md-12 text-center">
                <div class="text">
                    ...
                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
                        laborumfugiat quo voluptas nulla pariatur.</p>
                </div>
            </div>
            <div class="col-md-4 listone">
                <div class="col-md-3 listone-left-img">
                    <img src="../assets/images/plane.png" alt="">
                </div>
                <div class="col-md-9 listone-left-con">
                    <h2>At vero eos et accusamus et iusto repellendus</h2>
            ...
            <div class="services">
                ...
                <div class="col-md-4 menu">
                    <img src="../assets/images/5.5.jpg" alt="">
                    <h3>Itaque Earum Rerum Hic Tenetur</h3>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia
                        non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                </div>
                ...
                <div class="col-md-4 menu">
                    <img src="../assets/images/7.7.jpg" alt="">
                    <h3>Itaque Earum Rerum Hic Tenetur</h3>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia
                        non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                </div>
                <div class="col-md-4 menu">
                    <img src="../assets/images/8.8.jpg" alt="">
                    <h3>Itaque Earum Rerum Hic Tenetur</h3>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia
                        non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                </div>
                <div class="col-md-4 menu">
                    <img src="../assets/images/9.9.jpg" alt="">
                    <h3>Itaque Earum Rerum Hic Tenetur</h3>
                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia
                        non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                </div>
